  ...
  <nav ref="navbar" class="fixed top-0 left-0 w-full bg-primary-200 z-20 transition duration-200"> 
    <div class="container flex items-center justify-between h-20">
      ...
      <div class="flex lg:hidden items-center gap-2">
        <button class="relative z-30 px-4 py-2 -mt-1.5 text-sm rounded-full text-white font-medium tracking-wider uppercase bg-secondary w-full lg:w-auto">Buy Tickets</button>
      ...
      >
        <a 
        @click="showMenu = false" class="text-white font-medium" href="#home">
        Home
        </a>
        <a 
        @click="showMenu = false" class="text-white font-medium" href="#category">
        Category
        </a>
        <a 
        @click="showMenu = false" class="text-white font-medium" href="#about">
        About
        </a>
        <a 
        @click="showMenu = false" class="text-white font-medium" href="#trick-or-treat">
        Trick or Treat
        </a>
        <button 
