  ...
  <footer>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-28">
      <div>
        <div class="flex gap-2 mb-5">
           <h1 class="text-white font-bold text-lg lg:text-2xl">Peek<span class="text-secondary"> a’ </span>Boo</h1>
        ...
        <p class="text-white leading-loose tracking-wide w-full md:w-[80%]">Prepare for Halloween now by ordering a ticket to Pick'a'Boo, one of the biggest spooky events for kids and adults. Single entry,
        $39 with single entrance ticket, Couple entry, $75 with double entrance tickets and lots more.</p>
    ...
    <div class="grid place-items-center my-20 w-full ">
      <div class="flex items-center gap-10">
        <a href="https://github.com/Vinyl-Davyl" target="_blank" class="bg-secondary h-12 w-12 grid place-items-center rounded-md">
          <img src="../assets/images/social/fb.svg" alt="">
        </a>
        <a href="https://instagram.com/Vinyl-Davyl" target="_blank" class="bg-secondary h-12 w-12 grid place-items-center rounded-md">
          <img src="../assets/images/social/instagram.svg" alt="">
        </a>
        <a href="https://twitter.com/Vinylchi" target="_blank"  class="bg-secondary h-12 w-12 grid place-items-center rounded-md">
          <img src="../assets/images/social/twitter.svg" alt="">
        </a>
      </div>
      <p class="md:text-lg font-medium text-center text-white mt-8 tracking-wider">
        &copy; Copyright, Peek a' Boo. All rights reserved.
      </p>
    </div>
  </footer>
</template>